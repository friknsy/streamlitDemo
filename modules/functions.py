...
azure_llm =AzureChatOpenAI(
    ## 랭체인 안의 매개 변수들
    api_key="44c4edfe72fe46c8b8af8b0128b4e9d8",
    azure_endpoint="https://formachinelearningstudio.openai.azure.com/",
    api_version="2024-02-15-preview",
    azure_deployment="gpt-35-turbo-0613-demo",
)

_username =        "yrlee@zalesia.co.kr"#st.secrets["FABRIC_USERNAME"]
_password =        "71040101yr*^^*"#st.secrets["FABRIC_PASSWORD"]
_fabric_endpoint = "ewcih6goojaerchrwjcdkqtqwu-ey5yqgnsqisefmnb3wo4nxmhiu.datawarehouse.fabric.microsoft.com"#st.secrets["FABRIC_ENDPOINT"]
_fabric_database = "DWforAiStudio"#st.secrets["FABRIC_DATABASE"]
